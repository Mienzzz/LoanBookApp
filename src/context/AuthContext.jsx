...
const INITIAL_USERS = [
  { id: 'admin', username: 'admin', password: '123', name: 'Admin System', role: 'admin' },
  { id: 'user1', username: 'user1', password: '123', name: 'User Biasa 1', role: 'user' },
  { id: 'user2', username: 'user2', password: '123', name: 'User Biasa 2', role: 'user' },
];
